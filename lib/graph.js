...
var request      = require('request')
  ...
  , JSONbigint = require('json-bigint')({"storeAsString": true})
  , noop         = function(){};
...
exports.batch = function (reqs, additionalData, callback) {
  ...
  return new Graph('POST', '', extend({}, {
    ...
    batch: JSONbigint.stringify(reqs)
...
exports.fql = function (query, params, callback) {
  if (typeof query !== 'string') query = JSONbigint.stringify(query);
